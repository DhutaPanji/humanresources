...
include './config.php'; // Pastikan koneksi DB disertakan
...
// Query jumlah absensi hari ini
$tanggalHariIni = date('Y-m-d');
$jumlahAbsensiQuery = mysqli_query($conn, "SELECT COUNT(*) as total_absen FROM absensi WHERE tanggal = '$tanggalHariIni'");
